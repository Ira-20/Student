...
namespace StudentApp.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SId,Sname,SDOB,Contact")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SId,Sname,SDOB,Contact")] Student student)
        {
            if (id != student.SId)
            {
                return NotFound();
